...
export const menuData: MenuItem[] = [
  ...
  {
    id: 'bd-1',
    name: '[BUNDLING] - Ricebowl Chicken Popcorn Sambal Matah + Tea',
  ...
  },
  {
    ...
    category: 'bundle',
    image: getImagePath('bundling/6'),
    isRamadhan: true,
  },
  {
    id: 'bd-4',
    name: '[BUNDLING] - Ayam Bakar + Air Mineral',
    description: 'Nasi Ayam Bakar Cabe Ijo + Air mineral',
    kategori: [{ jenis: 'Paket', harga: 33000 }],
    category: 'bundle',
    image: getImagePath('bundling/3'),
    isRamadhan: true,
  },
  {
    id: 'bd-5',
    name: '[BUNDLING] - Ayam Goreng + Air Mineral',
    description: 'Nasi Ayam Goreng Serundeng Cabe Ijo + Air mineral',
    kategori: [{ jenis: 'Paket', harga: 33000 }],
    category: 'bundle',
    image: getImagePath('bundling/2'),
    isRamadhan: true,
  },
  {
    id: 'bd-6',
    name: '[BUNDLING] - Paket Nasi Liweut 6 Orang',
    description: '',
    kategori: [{ jenis: 'Paket', harga: 240000 }],
    category: 'bundle',
    image: getImagePath('bundling/7'),
    isRamadhan: true,
  },
  {
    id: 'bd-7',
    name: '[BUNDLING] - Paket Nasi Liweut 8 Orang',
    description: '',
  ...
  {
    id: 'bd-8',
    name: '[BUNDLING] - Paket Nasi Liweut 10 Orang',
    description: '',
    kategori: [{ jenis: 'Paket', harga: 400000 }],
    category: 'bundle',
    image: getImagePath('bundling/8'),
    isRamadhan: true,
  },
