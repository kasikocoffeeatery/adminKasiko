...
export const menuData: MenuItem[] = [
  ...
  },
  {
    ...
    kategori: [{ jenis: 'reguler', harga: 23000 }],
    category: 'coffee-milk',
    image: getImagePath('Oriental Signature'),
  },
  {
    id: 'cm-3',
    name: 'Baileys Coffee',
    ...
    kategori: [{ jenis: 'reguler', harga: 25000 }],
    category: 'coffee-milk',
  ...
  },
  {
    ...
    kategori: [{ jenis: 'reguler', harga: 25000 }],
    category: 'coffee-milk',
    image: getImagePath('Hazelnut Harmony'),
  },
  {
    id: 'cm-6',
    name: 'Cendol Creme',
  ...
  },
  {
    ...
    kategori: [{ jenis: 'reguler', harga: 25000 }],
    category: 'coffee-milk',
    image: getImagePath('Banana Creme'),
  },
  {
    id: 'cm-8',
  ...
  },
  {
    ...
    kategori: [{ jenis: 'reguler', harga: 28000 }],
    category: 'coffee-milk',
    image: getImagePath('Salted Butter Symphony'),
  },
  {
    id: 'cm-11',
  ...
  },
  {
    ...
    kategori: [{ jenis: 'reguler', harga: 28000 }],
    category: 'coffee-milk',
    image: getImagePath('TREVISO CRUMBLE'),
  },
  ...
  },
  {
    id: 'nc-4',
    name: 'Charcoal',
    description: 'Charcoal dengan susu steamed',
    kategori: [{ jenis: 'reguler', harga: 25000 }],
    category: 'non-coffee',
    image: getImagePath('Charcoal'),
  },
  {
    id: 'nc-5',
  ...
  },
  {
    ...
    kategori: [{ jenis: 'reguler', harga: 23000 }],
    category: 'mocktail',
    image: getImagePath('Rosella Royale'),
  },
  {
    id: 'mk-4',
    name: 'Crimson Muse',
  ...
  },
  {
    ...
    kategori: [{ jenis: 'reguler', harga: 23000 }],
    category: 'mocktail',
    image: getImagePath('Tropical Zing'),
  },
  {
    id: 'mk-6',
    name: 'Velvet Garden',
    ...
    kategori: [{ jenis: 'reguler', harga: 23000 }],
    category: 'mocktail',
    image: getImagePath('Velvet Garden'),
  },
  {
    id: 'mk-7',
    name: 'Hanami Bliss',
  ...
  },
  {
    ...
    kategori: [{ jenis: 'reguler', harga: 28000 }],
    category: 'frappe-series',
    image: getImagePath('Strawberry Frappucino'),
  },
  {
    id: 'fr-4',
  ...
  },
  {
    ...
    // Tea Based
    {
      ...
      kategori: [{ jenis: 'reguler', harga: 18000 }],
      category: 'tea-based',
      image: getImagePath('Lemon Tea'),
    },
    {
      id: 'tb-2',
      name: 'Lychee Tea',
    ...
    // Manual Brew
    {
      ...
      kategori: [{ jenis: 'reguler', harga: 30000 }],
    ...
    },
    {
      ...
      name: 'Import Beans',
      description: '',
      kategori: [{ jenis: 'reguler', harga: 60000 }],
      category: 'manual-brew',
      image: getImagePath('Manual Brew'),
    },
  ...
  // Milk Based
  {
    ...
    kategori: [{ jenis: 'reguler', harga: 20000 }],
    category: 'milk-based',
  ...
  },
  {
    ...
    kategori: [{ jenis: 'reguler', harga: 8000 }],
    category: 'espresso-based',
  ...
  },
  {
    ...
    name: 'Double Shot',
    description: 'Espresso dengan air panas yang lebih banyak',
    kategori: [{ jenis: 'reguler', harga: 16000 }],
    category: 'espresso-based',
  ...
  // Ricebowl
  {
    ...
    kategori: [{ jenis: 'reguler', harga: 33000 }],
    category: 'ricebowl',
  ...
  { 
    ...
    kategori: [{ jenis: 'reguler', harga: 29000 }],
    category: 'ricebowl',
    image: getImagePath('Chicken Popcorn BBQ Sauce'),
  },
  ...
  },
  {
    ...
    kategori: [{ jenis: 'reguler', harga: 25000 }],
    category: 'local-dish',
    image: getImagePath('Nasi Goreng Kampung'),
    isPopular: true,
  },
  {
    id: 'ld-5',
  ...
  },
  {
    ...
    kategori: [{ jenis: 'reguler', harga: 32000 }],
    category: 'local-dish',
  ...
  },
  {
    ...
    kategori: [{ jenis: 'reguler', harga: 17000 }],
    category: 'cake-cookies',
  ...
  },
  {
    ...
    kategori: [{ jenis: 'reguler', harga: 15000 }],
    category: 'cake-cookies',
  ...
  },
  {
    ...
    kategori: [{ jenis: 'reguler', harga: 22000 }],
    category: 'snack',
    image: getImagePath('Trufle Fries'),
  },
  {
    id: 'sn-4',
    name: 'Mix Platter',
  ...
  },
  {
    ...
    kategori: [{ jenis: 'reguler', harga: 18000 }],
    category: 'snack',
    image: getImagePath('Tahu Cabe Garam'),
  },
  {
    id: 'sn-9',
    name: 'Onion Rings',
  ...
  },
  {
    ...
    kategori: [{ jenis: 'reguler', harga: 28000 }],
    category: 'spaghetti',
    image: getImagePath('Spaghetti Bolognese'),
  },
  {
    id: 'sp-3',
